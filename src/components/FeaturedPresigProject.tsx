        ...
        <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-orange/10 via-gray-800/80 to-gray-900/80 backdrop-blur-sm border-2 border-orange/30 hover:border-orange/60 transition-all duration-500 hover:scale-[1.01]">
          ...
          <div className="relative z-10 p-8 lg:p-10">
            ...
            <div className="flex justify-start lg:justify-end mb-6">
              <div className="px-4 py-2 text-sm font-bold rounded-full bg-orange/90 text-gray-900 backdrop-blur-sm border-2 border-orange shadow-lg animate-pulse flex items-center space-x-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3 text-gray-300">
                    ...
                    <span className="text-sm">
                      Deterministic decoding of ERC-20, NFT, and DeFi
                      transactions
                    </span>
                  </div>
                  <div className="flex items-start gap-3 text-gray-300">
