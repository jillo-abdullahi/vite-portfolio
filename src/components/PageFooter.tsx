...
export const PageFooter = () => {
  return (
    <div
      className="absolute bottom-0 left-0 right-0 w-full px-4 md:px-8 lg:px-26 xl:px-42 border-t-2 border-b-2 border-[var(--color-primary)]/10 mb-4 bg-[var(--color-primary)]/3"
      style={{
