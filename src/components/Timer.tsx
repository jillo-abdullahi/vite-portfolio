...
const Timer: FC = () => {
  ...
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-900/40 backdrop-blur-sm border border-[var(--color-primary)]/10 hover:border-[var(--color-primary)]/30 transition-colors duration-300">
