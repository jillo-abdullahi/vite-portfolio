    ...
    <div className="flex-1 relative w-full max-w-[500px] md:max-w-none flex justify-center z-10 p-6 md:p-0">
      ...
      >
        <div className="relative w-56 h-56 md:w-64 md:h-64 group">
          ...
          <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-[var(--color-primary)]/20 backdrop-blur-sm bg-gray-100/70 dark:bg-gray-900/50 transition-all duration-500">
            <img
          ...
          {/* Floating Badges */}
          <div
            className="absolute -top-0 -right-0 bg-gray-100/70 dark:bg-gray-900/60 backdrop-blur-md border border-[var(--color-primary)]/15 p-2 rounded-[12px] animate-float"
            style={{ animationDelay: "0s" }}
          >
            <FaReact className="text-[#61DAFB] text-2xl" />
          </div>
          <div
            className="absolute bottom-8 -left-8 bg-gray-100/70 dark:bg-gray-900/60 backdrop-blur-md border border-[var(--color-primary)]/15 p-2 rounded-[12px] animate-float"
            style={{ animationDelay: "-2s" }}
          >
            <BiLogoTypescript className="text-[#3178C6] text-2xl" />
          </div>
          <div
            className="absolute -bottom-4 right-12 bg-gray-100/70 dark:bg-gray-900/60 backdrop-blur-md border border-[var(--color-primary)]/15 p-2 rounded-[12px] animate-float"
