      ...
      <div className="group relative flex flex-col md:flex-row rounded-3xl overflow-hidden bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-[var(--color-primary)]/20 hover:border-[var(--color-primary)]/80 border-2 transition-all duration-300 hover:scale-[1.01] shadow-lg shadow-[var(--color-primary)]/5">
        ...
        <div className="relative w-full md:w-[46%] p-6 md:p-7 overflow-hidden bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-black/80 border-b md:border-b-0 md:border-r border-[var(--color-primary)]/20 flex items-center justify-center">
          ...
          <div className="relative max-w-3xl mx-auto">
            <div className="relative bg-gradient-to-b from-gray-900 to-black rounded-[22px] p-3 shadow-2xl border border-gray-700/50">
              {/* Top bar */}
              <div className="flex items-center justify-between h-9 px-4 rounded-[14px] bg-gray-900/80 border border-gray-700/60">
              ...
              {/* Simple screen card */}
              <div className="relative mt-3 overflow-hidden rounded-xl border border-gray-800/80 bg-gray-900 shadow-inner">
        ...
        <div className="flex-1 flex flex-col p-6 md:p-8 space-y-4 bg-gray-950/40 md:border-l md:border-[var(--color-primary)]/20">
          ...
          <div className="flex-1 border-t border-gray-700 pt-4">
            {stacks && stacks.length > 0 && (
              <div className="space-y-2">
                <p className="text-xs font-semibold text-gray-300 uppercase tracking-wider pb-1">
                  Tech Stack
                </p>
          ...
          <div className="hidden sm:flex flex-wrap gap-3 pt-3 transition-opacity duration-300">
            {preview && (
              <a
                ...
                className="group/btn flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-300/70 bg-[var(--color-primary)]/90 hover:bg-[var(--color-primary)] text-gray-900 text-sm font-semibold transition-colors duration-200 shadow-lg backdrop-blur-sm"
            ...
            {github && contract ? (
              <div className="relative">
                <button
                  ...
                  className="group/btn flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-400/40 bg-gray-900/80 hover:bg-gray-800 text-gray-100 text-sm font-semibold transition-colors duration-200 shadow-lg backdrop-blur-sm cursor-pointer"
                ...
                >
                  <CodeXmlIcon ref={codeIconRef} className="h-4 w-4" />
                  <span className="group-hover/btn:translate-y-[-1px] transition-transform duration-200">
                    code
                  </span>
                  <ChevronDownIcon
                ...
                {codeMenuOpen && (
                  <div className="absolute z-30 -top-20 w-44 rounded-lg overflow-hidden border border-gray-700/70 bg-gray-900/95 shadow-2xl backdrop-blur-sm">
                    <a
                      href={github}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 text-sm text-gray-100 hover:bg-gray-800/90 transition-colors"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 text-sm text-gray-100 hover:bg-purple-900/50 transition-colors"
                    >
              ...
              <>
                {github && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-400/40 bg-gray-900/80 hover:bg-gray-800 text-gray-100 text-sm font-semibold transition-colors duration-200 shadow-lg backdrop-blur-sm"
                ...
                {contract && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 rounded-lg border border-purple-300/40 bg-purple-900/80 hover:bg-purple-800 text-gray-100 text-sm font-semibold transition-colors duration-200 shadow-lg backdrop-blur-sm"
