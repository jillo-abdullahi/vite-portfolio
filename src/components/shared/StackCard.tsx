...
export const StackCard: FC<StackCardProps> = ({ title, icon, skills }) => {
  ...
  return (
    <div
      ref={cardRef}
      className="group relative h-full p-6 rounded-3xl border border-[var(--color-primary)]/10 bg-gray-900/20 backdrop-blur-sm hover:border-[var(--color-primary)]/30 hover:-translate-y-1 hover:shadow-xl hover:shadow-[var(--color-primary)]/5 transition-all duration-500 ease-out overflow-hidden">
