...
export const NavSocialLinks = ({
  ...
  <div className="flex items-center space-x-2 h-full">
    <a
      ...
      className="flex items-center justify-center w-11 h-11 rounded-xl text-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 transition-all duration-200 border border-[var(--color-primary)]/20 bg-gray-100 dark:bg-gray-700/10 hover:bg-gray-200 dark:hover:bg-gray-700/20"
