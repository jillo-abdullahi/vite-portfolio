...
const NavigationCard: FC<NavigationCardProps> = ({
  ...
  return (
    ...
    >
      <Link
        to={href}
        className="group flex flex-col items-center p-3 bg-gray-800/50 rounded-2xl border-2 border-[var(--color-primary)]/15 hover:border-[var(--color-primary)]/20 hover:bg-gray-800/70 transition-all duration-200"
      >
        <Icon
