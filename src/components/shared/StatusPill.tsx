...
import { FaCode, FaMugHot, FaGamepad } from "react-icons/fa";
import { MdOutlineEventAvailable } from "react-icons/md";
import { GrTools } from "react-icons/gr";
import { LuRocket, LuTreePalm } from "react-icons/lu";
...
export const StatusPill: React.FC<StatusPillProps> = ({
  ...
  const baseClasses =
    "bg-gray-800/90 border-2 border-orange/60 text-orange/80 rounded-full px-2 py-1 flex items-center backdrop-blur-sm shadow-lg";
