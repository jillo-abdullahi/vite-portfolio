...
export const ViewProjectsBtn = () => {
  ...
  return (
    ...
    >
      <Link
        type="button"
        className="group relative inline-flex items-center gap-x-1.5 rounded-lg border border-gray-700/40 bg-gray-700/10 hover:bg-gray-700/20 px-4 py-1.5 text-gray-300 hover:text-gray-200 shadow-sm hover:border-gray-700/60 transition-all duration-200 cursor-pointer"
        to={"/projects"}
      >
        <LayoutGridIcon
          ref={gridRef}
